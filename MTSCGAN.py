...
class Discriminator(nn.Module):
    def __init__(self,
        ...
        self.l5 = nn.Linear(3, 150)
        self.l6 = nn.Linear(4, 3)
    ...
    def forward(self, sig, context):
        ...
        context = context.view(-1, 1, 3) 
        context_l = self.l5(context)
        sig = sig.view(-1,3,150)
        ...
        real_input_disc = torch.transpose(transp_cat_l,1,2).view(-1,3,1,150)
